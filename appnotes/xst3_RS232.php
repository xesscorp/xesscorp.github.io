...
<meta name="description" content="RS232 is a simple design example that echoes characters received through the RS232 port of the XST-3.0 Board back to the sending terminal.">
...
<ul class="breadcrumb">
<li id="breadcrumb-menu-learn"><a href="../learn/index.html">Learn</a><span class="divider">&gt;&gt;</span></li><li id="breadcrumb-menu-projects"><a href="../design_examples.php">Design Examples</a><span class="divider">&gt;&gt;</span></li><li id="breadcrumb-menu--projects-"><a href="../design_examples.php">XESS</a><span class="divider">&gt;&gt;</span></li><li id="breadcrumb-menu-projects-xst3_rs232-project"
        class="active">xst3_RS232 Project</li>
</ul>
...
<div class="span9 middle">
    ...
    <div>
        ...
        <div class="assetfield-content">01/25/2006</div>
    </div>
    ...
    <div>
        ...
        <div class="assetfield-content">
            <a href="../projects/xst3_RS232.zip">
                /static/media/projects/xst3_RS232.zip
            </a>
        </div>
    </div>
...
<h1>Using the RS232 Port on the XST-3.0 Board</h1>
<p></p>
<ul>
<li><a href="xst3_RS232.php#using_the_rs232_port_on_the_xst3_0_board">USING THE RS232 PORT ON THE XST-3.0 BOARD</a></li>
<li><a href="xst3_RS232.php#design_files">DESIGN FILES</a></li>
<li><a href="xst3_RS232.php#using_the_design_example">USING THE DESIGN EXAMPLE</a></li>
<li><a href="xst3_RS232.php#environment">ENVIRONMENT</a></li>
<li><a href="xst3_RS232.php#source_files">SOURCE FILES</a></li>
<li><a href="xst3_RS232.php#author">AUTHOR</a></li>
<li><a href="xst3_RS232.php#copyright_and_license">COPYRIGHT AND LICENSE</a></li>
<li><a href="xst3_RS232.php#history">HISTORY</a></li>
</ul>
<!-- INDEX END --><hr>
<p></p>
<hr>
<h1><a name="using_the_rs232_port_on_the_xst3_0_board"></a>USING THE RS232 PORT ON THE XST-3.0 BOARD</h1>
<p>This is a simple design example that echoes characters received through the RS232 port of the XST-3.0 Board back to the sending terminal.</p>
<p></p>
<hr>
<h1><a name="design_files"></a>DESIGN FILES</h1>
<ul>
<ul>
<li><strong><a name="item_miniuart_2evhd_2c_rxunit_2evhd_2c_txunit_2evhd_2c_"></a><em>miniuart.vhd</em>, <em>Rxunit.vhd</em>, <em>Txunit.vhd</em>, <em>utils.vhd</em></strong></li>
These are the design files for a UART that is used to send and receive eight-bit data through the DB9 connector on the XST-3.0 Board. Some small changes were made to these design files, but I can't quite remember what they were. The original files are stored in the</ul>
</ul>
<em>MiniUART.tar.gz</em>
<ul>
<ul>archive if you want to check.</ul>
</ul>
<p></p>
<ul>
<ul>
<li><strong><a name="item_rs232_2evhd"></a><em>RS232.vhd</em></strong></li>
This is the VHDL file that describes a simple state machine that accepts characters received by the UART module and then transmits them back through the UART to the terminal that sent them.</ul>
</ul>
<p></p>
<ul>
<ul>
<li><strong><a name="item_rs232_2eucf"></a><em>RS232.ucf</em></strong></li>
These are the constraints which assign the I/O signals of the RS232 module to the appropriate pins of the FPGA on the XSA-3S1000 + XST-3.0 combination.</ul>
</ul>
<p></p>
<ul>
<ul>
<li><strong><a name="item_rs232_2ebit"></a><em>RS232.bit</em></strong></li>
This is a compiled bitstream for the design that can be downloaded into the XSA-3S1000 + XST-3.0 combination.</ul>
</ul>
<p></p>
<ul>
<ul>
<li><strong><a name="item_rs232_2d200_2eucf"></a><em>RS232-200.ucf</em></strong></li>
This is an alternate set of pin assignments to be used if the design is recompiled for an XSA-200 + XST-3.0 combination.</ul>
</ul>
<p></p>
<ul>
<ul>
<li><strong><a name="item_rs232_2enpl"></a><em>RS232.npl</em></strong></li>
...
Connect a straight-thru serial cable between the PC and the female DB9 connector of the XST-3.0 Board. On the XST-3.0 Board near the DB9 connector, make sure the shunts are arranged to connect the following pins on header J7: 1-3, 2-4, 5-7, 6-8.</ul>
</ul>
<p></p>
<ul>
<li><strong><a name="item_step_4_3a"></a>Step 4:</strong></li>
On the PC, open a Hyperterminal window with the following settings:</ul>
...
Download the <em>RS232.bit</em>file to the XSA Board.
<p></p>
<ul>
<li><strong><a name="item_step_6_3a"></a>Step 6:</strong></li>
</ul>
...
<p>You can download the source files for this example design from the XESS website at <a href="../projects/xst3_RS232.zip">/projects/xst3_RS232.zip</a> .</p>
<p></p>
<hr>
...
<p>01/28/2006 - Initial release.</p>
</div>
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fprojects%252Fxst3_rs232-project%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fprojects%252Fxst3_rs232-project%252F"
