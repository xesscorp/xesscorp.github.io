...
<ul class="breadcrumb">
<li id="breadcrumb-menu-learn"><a href="learn/index.html">Learn</a><span class="divider">&gt;&gt;</span></li><li id="breadcrumb-menu-software"
        class="active">Software Tools</li><li id="breadcrumb-menu--software-"><a href="downloads.php">XESS</a><span class="divider">&gt;&gt;</span></li>
</ul>

<h1>
XESS Software Applications
</h1>
    ...
    <!-- This is the main content block. -->
        ...
        <table class="table-bordered table-striped table-hover sortable">
            <thead>
                <tr class="asset-list">
                    <th>
                        <a href="downloads.php#" data-toggle="tooltip" title="Click to sort">
                            Application
                        </a>
                    </th>
                    <th width="15%">
            ...
            <tbody>
                ...
                <tr class="asset-list">
                    <td>
                        <a href="https://pypi.python.org/pypi/xsconnect">
                            <strong>xsconnect</strong>
                        </a>
                        
                            <br><div style="padding-left: 20px;">This tool generates the FPGA pin assignments for the connection of a given peripheral board to a StickIt! motherboard with a XuLA FPGA board.</div>
                        
                        
                            <div style="float:right; font-size:11px;"><a href="http://www.xess.com/software/xsconnect/"><em>Details>></em></a></div>
                        
                    </td>
                    <td align="center">05/25/2015</td>
                </tr>
            
                <tr class="asset-list">
                    <td>
                        <a href="https://pypi.python.org/pypi/XsTools">
                            <strong>XSTOOLs (Python Version)</strong>
                        </a>
                        
                            <br><div style="padding-left: 20px;">A version of the XSTOOLs software written in Python.</div>
                        
                        
                            <div style="float:right; font-size:11px;"><a href="software/xstools-python-version/index.html"><em>Details>></em></a></div>
                        
                    </td>
                    <td align="center">11/21/2013</td>
                </tr>
            
                <tr class="asset-list">
                    <td>
                        <a href="static/media/software/setup-XSTOOLs-full-5_1_4_1.exe">
                            <strong>setup-xstools-full-5_1_4_1</strong>
                        </a>
                        
                            <br><div style="padding-left: 20px;">XSTOOLs Version 5.1.4.1 (full): Setup file for the utilities that download and exercise the XuLA2 (including the XuLA2-LX9), XuLA, XSUSB, XSA, XSB, XSV, XS40 and XS95 Boards.  Also installs board manuals, design examples and other documentation.  For 32-bit and 64-bit versions of Windows 8, Windows 7, Vista, WinXP and Win2K.</div>
                        
                        
                            <div style="float:right; font-size:11px;"><a href="software/setup-xstools-full-5_1_4_1/index.html"><em>Details>></em></a></div>
                ...
                <tr class="asset-list">
                    <td>
                        <a href="static/media/software/setup-XSTOOLs-5_1_4_1.exe">
                            <strong>setup-xstools-5_1_4_1</strong>
                        </a>
                        
                            <br><div style="padding-left: 20px;">XSTOOLs Version 5.1.4 (executables): Setup file for the utilities that download and exercise the XuLA2 (including the XuLA2-LX9), XuLA, XSUSB, XSA, XSB, XSV, XS40 and XS95 Boards.  For 32-bit and 64-bit versions of Windows 8, Windows 7, Vista, WinXP and Win2K.</div>
                        
                        
                            <div style="float:right; font-size:11px;"><a href="software/setup-xstools-5_1_4_1/index.html"><em>Details>></em></a></div>
                ...
                <tr class="asset-list">
                    <td>
                        <a href="static/media/software/img2xes.zip">
                            <strong>img2xes</strong>
                        </a>
                        
                            <br><div style="padding-left: 20px;">Img2xes: Perl script that converts various image formats into the XES hex format for  downloading to the XS Board RAM.</div>
                        
                        
                            <div style="float:right; font-size:11px;"><a href="software/img2xes/index.html"><em>Details>></em></a></div>
                        
                    </td>
                    <td align="center">08/28/2005</td>
                </tr>
            
                <tr class="asset-list">
                    <td>
                        <a href="static/media/software/xsa-ucf.zip">
                            <strong>xsa-ucf</strong>
                        </a>
                        
                            <br><div style="padding-left: 20px;">XSA UCF: UCF files for the FPGA and CPLD on the XSA-50 and XSA-100 Board.</div>
                        
                        
                            <div style="float:right; font-size:11px;"><a href="software/xsa-ucf/index.html"><em>Details>></em></a></div>
                        
                    </td>
                    <td align="center">03/08/2004</td>
                </tr>
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="accounts/login/index.html?next=%252Fsoftware%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="account/signup/index.html?next=%252Fsoftware%252F"
