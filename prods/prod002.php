...
<meta name="description" content="XESS XS95-108 CPLD plus 8051-microcontroller development board.">
<title>XS95-108 | XESS Corp.</title>
...
<script>var variations = [{"sku": "X00002", "image_id": 58, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-58-large"><a class="product-image-large thumbnail" rel="#image-full-58" href="../images/XS95-1_3-LABELED.png"><img alt="XS95-108 image 0" src="../static/media/product/.thumbnails/XS95-1_3-LABELED-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-58"><img src="../images/XS95-1_3-LABELED.png"></div></li></ul>
...
<ul class="features"><li>XC95108 CPLD with XS_CPLD_SIZE macrocells</li> 
...
<ul class="documentation"><li><a href="../manuals/xs95-manual-v1_3.pdf">XS95-108 Board Manual (PDF file)</a>
	</li></ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="41" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593966998" /><input id="id_security_hash" name="security_hash" type="hidden" value="0f7835cd0fb154c283479613ea37b84ba74efced" /></li></ul>
...
<div class="StdPageBody">
	...
	The XS95-108 Board is perfect for experimenting with CPLD designs, microcontroller programming, or 
	hardware/software codesign.&#160; You can implement logic circuitry with the CPLD.&#160; 
	The microcontroller can use the CPLD as a coprocessor.&#160; The 32 KByte SRAM can store 
	microcontroller programs/data or serve as general-purpose storage for CPLD-based designs. 
	<p>The XC9500 series of CPLDs is supported by Xilinx's Foundation and Alliance Series software.
	</p><table align="center"><tr><td align="center"><img src="../images/XS95-1_3-LABELED.png" alt="XESS product picture"/></td></tr></table></div>
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fxs95-108%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fxs95-108%252F"
