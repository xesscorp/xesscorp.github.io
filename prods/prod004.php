...
<meta name="description" content="XESS XS40-005XL FPGA plus 8051-microcontroller development board.">
<title>XS40-005XL | XESS Corp.</title>
...
<script>var variations = [{"sku": "X00004", "image_id": 52, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-52-large"><a class="product-image-large thumbnail" rel="#image-full-52" href="../images/XS40-1_4-LABELED.png"><img alt="XS40-005XL image 0" src="../static/media/product/.thumbnails/XS40-1_4-LABELED-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-52"><img src="../images/XS40-1_4-LABELED.png"></div></li></ul>
...
<ul class="features"><li>Not supported by WebPACK or the Xilinx Student Edition of Foundation 4.1i</li> 
      <li>XC4005XL FPGA</li> 
      <li>8031 microcontroller</li> 
      <li>32-KByte SRAM</li> 
      ...
      <li>7-segment LED</li> 
      <li>84-pin prototyping&#160; interface</li> 
      <li>Serial EEPROM socket</li> 
...
<ul class="documentation"><li><a href="../manuals/xs40-manual-v1_4.pdf">XS40-005XL Board Manual (PDF file)</a>
	</li></ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="35" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593966979" /><input id="id_security_hash" name="security_hash" type="hidden" value="d4f584b83c3172d7d5ea9db0455d84ff703ae83b" /></li></ul>
...
<div class="StdPageBody">
    ...
    The XS40-005XL Board 
    is perfect for experimenting with FPGA designs, microcontroller programming, or 
    hardware/software codesign.&#160; The 9,000-gate XC4005XL FPGA operates at 5V so you can 
    connect it to commonly available TTL chips.&#160; Digital logic designs can be loaded into 
    the FPGA.&#160; The microcontroller can use the FPGA as a coprocessor.&#160; The 32-KByte SRAM can 
    store microcontroller programs/data or serve as general-purpose storage for FPGA-based 
    designs.<p>The XC4005XL series of FPGAs is supported by 
    Xilinx's Foundation and Alliance Series.
	</p><table align="center"><tr><td align="center"><img src="../images/XS40-1_4-LABELED.png" alt="XESS product picture"/></td></tr></table></div>
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fxs40-005xl%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fxs40-005xl%252F"
