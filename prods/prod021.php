...
<meta name="description" content="XESS XSTE5 Triscend CSoC development board.">
<title>XSTE5 | XESS Corp.</title>
...
<script>var variations = [{"sku": "X00021", "image_id": 39, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-39-large"><a class="product-image-large thumbnail" rel="#image-full-39" href="../images/XSTE5-1_0-LABELED.png"><img alt="XSTE5 image 0" src="../static/media/product/.thumbnails/XSTE5-1_0-LABELED-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-39"><img src="../images/XSTE5-1_0-LABELED.png"></div></li></ul>
...
<ul class="features"><li>Triscend TE505 CSoC</li> 
      <li>128 KByte SRAM</li> 
      <li>128 KByte Flash</li> 
      <li>100 MHz programmable oscillator</li> 
      <li>Parallel port</li> 
      <li>mouse/keyboard PS/2 port</li> 
      <li>VGA monitor port</li> 
      <li>7-segment LED</li> 
      <li>8 position DIP switch</li> 
      <li>84-pin protoboard interface</li> 
      <li>9V DC power jack</li> 
      <li>5V/3.3V regulators</li> 
      <li>Downloading cable</li> 
      <li>9V DC power supply (120V @ 60Hz)</li>
	</ul>
...
<ul class="documentation"><li><a href="../manuals/xste5-manual-v1_0.pdf">XSTE5 Board Manual (PDF file)</a>
	</li></ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="24" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593967050" /><input id="id_security_hash" name="security_hash" type="hidden" value="4231fc663786236c1df4266a57a60567ec722266" /></li></ul>
...
<div class="StdPageBody">
    ...
    The XSTE5 CSoC Board is 
    perfect for experimenting with hardware/software codesigns based on the Triscend TE505 
    Configurable System on a Chip (CSoC).&#160; The TE505 CSoC combines an 8032 
    microcontroller core with 512 cells of configurable system logic (CSL).&#160; You 
    customize the CSL with a variety of soft modules that act as peripherals for the 8032 
    while it executes your application code.&#160; The Triscend FastChip 1999 software helps you 
    integrate 8032 application code from a variety of third-party development tools with 
    Triscend's library of soft modules.&#160;&#160; Or you can build your own modules using 
    Orcad or other tools which output an EDIF netlist.
    <p>The XSTE5 Board provides additional circuitry that speeds your development process.&#160; Just 
    connect the XSTE5 Board to the parallel port of a PC and you can download your application 
    code and soft modules to the TE505 CSoC directly from the FastChip 1999 environment.&#160; Or 
    you can store your design in the 128 KByte Flash so it starts running whenever power is 
    applied to the board.&#160; An additional 128 KBytes of SRAM is provided for running 
    larger applications or for general-purpose data storage.&#160; The programmable 100 MHz 
    oscillator lets you select just the right speed that balances your design's performance 
    against its power consumption.</p> 
    <p>The FastChip 1999 software provides extensive in-circuit debugging 
    features through the cable attached to the XSTE5 Board.&#160; In addition, the 8-position 
    DIP switch and 7-segment LED on the board let you input control signals directly to the 
    TE505 and observe the results for diagnostic purposes.&#160; Or connect a keyboard or 
    mouse to the PS/2 port for more extensive input capabilities, while graphical output can 
    be displayed on a monitor attached to the VGA port.</p> 
    <p>The TE505 CSoC will be used in a wide variety of systems and 
    applications.&#160; The XSTE5 Board makes it easy to connect to external systems through 
    an 84-pin breadboard interface that gives you access to all the general-purpose I/O of the 
    CSoC.&#160; The TE505 operates at 3.3V but is 5V-tolerant so you can connect it to a wide 
    variety of chips.&#160; The on-board regulators of the XSTE5 Board generate all the 
    voltages you need from a single 9V DC power input.
	</p><table align="center"><tr><td align="center"><img src="../images/XSTE5-1_0-LABELED.png" alt="XESS product picture"/></td></tr></table></div>
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fxste5%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fxste5%252F"
