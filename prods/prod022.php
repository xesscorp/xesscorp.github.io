...
<meta name="description" content="XESS myCSoC Kit Triscend CSoC development board with FastChip 1999 software and tutorial.">
<title>myCSoC-Kit | XESS Corp.</title>
...
<script>var variations = [{"sku": "X00022", "image_id": 40, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-40-large"><a class="product-image-large thumbnail" rel="#image-full-40" href="../images/mycsoc.jpg"><img alt="myCSoC-Kit image 0" src="../static/media/product/.thumbnails/mycsoc-0x300.jpg"></a><div class="product-image-full" style="display:none;" id="image-full-40"><img src="../images/mycsoc.jpg"></div></li></ul>
...
<ul class="features"><li>FastChip 1999 software (see note!)</li> 
      <li><a href="http://www.xess.com/prods/prod043.php">myCSoC Tutorial CDROM</a></li> 
      <li><a href="prod021.php">XSTE5 CSoC Board</a></li> 
      <li>Downloading cable</li> 
      <li>9V DC power supply (120V @ 60Hz)</li> 
      <li>For use with Win95/98/ME/NT only!!</li>
	</ul>
...
<ul class="documentation"><li><a href="../manuals/xste5-manual-v1_0.pdf">myCSoC Kit Board Manual (PDF file)</a>
	</li></ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="25" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593967241" /><input id="id_security_hash" name="security_hash" type="hidden" value="86a41b9446699354fbc8dee4eacc0ca8559247d2" /></li></ul>
...
<div class="StdPageBody">
	...
	Everyone talks about system-on-a-chip design, but 
	the myCSoC Kit from XESS Corp. actually lets you do it!&#160; The kit is built 
	around the Triscend TE505 Configurable System on a Chip (CSoC) that contains an 
	enhanced 8032 microcontroller core combined with an array of configurable system logic (CSL).&#160; 
	By augmenting the 8032 with various soft modules loaded in the CSL, you can tradeoff between hardware 
	and software implementations of system functions to meet your performance goals. 
	<p>At just $169.95*, myCSoC Kit provides a complete environment with everything you 
	need for training or developing with CSoCs:</p> 
	<ul><li>Triscend's FastChip 1999 &#153; software for developing program code and soft modules for Triscend CSoCs; 
            <strong>(Note!!:</strong> This is a full version of the FastChip software with no restrictions.  
            However, you must request an updated FastChip 2.3.x CDROM before Triscend 
            will register your software and provide the license that enables all the features.  
            While they do not charge for this, there will be a delay while they ship the FastChip 2.3.x CDROM to you. 
            We apologize for the delay and inconvenience caused by this but there is nothing we can do about it.)
           </li> 
	<li><a href="http://www.xess.com/prods/prod043.php">"myCSoC" tutorial CDROM</a> that shows how the FastChip 1999 software is used to create and debug applications for Triscend CSoCs;</li> 
	<li>an <a href="prod021.php">XSTE5 CSoC Board</a> that works with all the example designs in the tutorial and serves as a general-purpose development board for the Triscend TE505 CSoC;</li> 
	<li>a downloading cable that attaches the CSoC Board to the parallel port of your PC;</li> 
	<li>a power supply for the CSoC Board.</li> 
	</ul><p>myCSoC Kit is easy to use: load the FastChip 1999 software, 
	connect the CSoC Board to your PC, and start developing and testing CSoC applications! 
	Then interface your design to external systems through the expansion interface that 
	gives you access to the TE505 I/O pins.  Once your development is complete, you can 
	program your design into the Flash RAM and use the CSoC Board in a stand-alone mode.</p>
    
	<table align="center"><tr><td align="center"><img src="../images/mycsoc.jpg" alt="XESS product picture"/></td></tr></table></div>
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fmycsoc-kit%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fmycsoc-kit%252F"
