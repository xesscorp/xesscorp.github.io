...
<meta name="description" content="The Xilinx Student Edition 2.1i Foundation software allows students to do logic design simulation and implementation for Xilinx CPLDs and FPGAs.">
<title>XSE-2.1 | XESS Corp.</title>
...
<script>var variations = [{"sku": "X00023", "image_id": null, "option2": null, "option1": null}];</script>
...
<ul class="features"><li>CDROM with Student Edition of XILINX Foundation 2.1 software</li> 
      <li><strong>Discount coupon</strong> for the <a href="prod002.php">XS95-108</a> and <a href="prod004.php">XS40-005XL</a> prototyping boards.</li> 
      <li>Online tutorials and labs at the <a href="http://xup.msu.edu">Michigan State Univ. web site</a>.</li>
	</ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="23" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593967045" /><input id="id_security_hash" name="security_hash" type="hidden" value="137ef1bd104f90f1f62ca94e19fa66966693450f" /></li></ul>
...
<div class="StdPageBody">
      ...
      The Xilinx Student Edition (XSE) is ideal for 
      ANY digital design course.&#160; The industry-standard Foundation 2.1i 
      software is easy for students to learn and lets instructors focus on 
      higher level design concepts.&#160; Advanced designers will appreciate the 
      many features of the software that allows them to create CPLD and FPGA 
      designs in record time. 
      <p><strong>Prentice Hall has stopped including <i>The Practical Xilinx Designer Lab Book</i> 
      in the Xilinx Student Edition 
      2.1i.&#160; This lowers the price, but eliminates the extensive tutorial 
      on the Foundation software with many worked examples.&#160; To make up for 
      this shortcoming, XESS Corp. is providing a series of free 
      <a href="http://www.xess.com/prods/prod046.php">tutorial examples</a>.</strong></p> 
      <h2>XSE 2.1i Features</h2> 
      <ul><li>Enter your design graphically using a <strong>schematic editor</strong> or 
          describe it textually with the <strong>hardware description language (HDL) 
          editor</strong>.&#160; Describe complex finite state machines using the <strong>state 
          diagram editor</strong>.&#160; Or import designs from OrCAD or Viewlogic.</li> 
        <li>Generate the logic for your design using the <strong>FPGA Express 
          synthesizer</strong> for the VHDL, Verilog, and ABEL HDLs.</li> 
        <li>Use the <strong>implementation tools</strong> to place and route your design 
          for any <strong>XC9500 CPLD</strong>, any <strong>Spartan FPGA</strong>, any <strong>XC4000 
          FPGA</strong> up to an XC4010, or the <strong>XCV50 Virtex FPGA</strong>.</li> 
        <li>Check your design's logical functions and timing with the integrated 
          <strong>simulator</strong>.</li> 
        <li>Target digital signal processing applications with Foundation's <strong>CoreGen</strong> 
          tools.</li> 
      </ul><h2>XSE 2.1i Limitations</h2> 
      <ul><li>No live technical support.&#160; Support is provided by FAQs and the 
          answer database at support.xilinx.com.</li> 
        <li>No automatic software updates or upgrades.</li> 
        <li>XC4000 FPGAs larger than the XC4010 are not supported.</li> 
        <li>Virtex FPGAs larger than the XCV50 are not supported.</li> 
      </ul><h2>Minimum System Requirements</h2> 
      <ul><li>Pentium processor with 120 MHz clock.</li> 
        <li>Windows 95, Windows 98, or Windows NT (SP3 or SP4).</li> 
        <li>32 MB system RAM, 48 MB swap space.</li> 
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fxse-21%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fxse-21%252F"
