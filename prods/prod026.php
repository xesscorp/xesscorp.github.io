...
<meta name="description" content="XESS XSA-100 FPGA plus 16 MByte SDRAM development board.">
<title>XSA-100 | XESS Corp.</title>
...
<script>var variations = [{"sku": "X00026", "image_id": 72, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-72-large"><a class="product-image-large thumbnail" rel="#image-full-72" href="../images/XSA-100-LABELED.png"><img alt="XSA-100 image 0" src="../static/media/product/.thumbnails/XSA-100-LABELED-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-72"><img src="../images/XSA-100-LABELED.png"></div></li><li id="image-73-large"style="display:none;"><a class="product-image-large thumbnail" rel="#image-full-73" href="../images/XSA-block-diag.png"><img alt="XSA-100 image 1" src="../static/media/product/.thumbnails/XSA-block-diag-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-73"><img src="../images/XSA-block-diag.png"></div></li></ul><ul id="product-images-thumb" class="thumbnails"><li><a class="thumbnail" id="image-72" href="../images/XSA-100-LABELED.png"><img alt="XSA-100 image 0" src="../static/media/product/.thumbnails/XSA-100-LABELED-75x75.png"></a></li><li><a class="thumbnail" id="image-73" href="../images/XSA-block-diag.png"><img alt="XSA-100 image 1" src="../static/media/product/.thumbnails/XSA-block-diag-75x75.png"></a></li></ul>
...
<ul class="features"><li>XC2S100 FPGA</li>
      <li>XC9572XL CPLD</li>
      <li>16 MByte SDRAM</li>
      <li>256 KByte Flash</li>
      <li>100 MHz programmable oscillator</li>
      <li>Parallel port</li>
      <li>Keyboard/mouse PS/2 port</li>
      <li>64-color VGA port</li>
      <li>7-segment LED</li>
      <li>1 pushbutton</li>
      <li>4 DIP switches</li>
      <li>84-pin prototyping interface (53 I/O pins)</li>
      <li>5V-tolerant I/O</li>
      <li>9V DC power jack</li>
      <li>5V / 3.3V / 2.5V regulators</li>
      <li>Downloading cable</li>
      <li><a href="prod045.php">XSTOOLs CD</a></li>
      <li>Works with the XST-4.0 Board</li>
      <li>Works with XILINX ISE, WebPACK, iMPACT and ChipScope software</li>
	</ul>
...
<ul class="documentation"><li><a href="../manuals/xsa-manual-v1_2.pdf">XSA-100 Board Manual (PDF file)</a>
	</li><li><a href="../manuals/XSA-100-pins.xls">XSA-100 Board Pin List (Excel file)</a>
	</li></ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="49" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593966692" /><input id="id_security_hash" name="security_hash" type="hidden" value="0864ef9ada4019d7dbaae988e47c9b1c84b4af32" /></li></ul>
...
<div class="StdPageBody">
	...
	<p>The XSA-100 Board keeps the same form-factor as our
	popular <a href="prod004.php">XS40 Boards</a> while increasing the logic
	density to 100,000 gates with a Spartan-2 XC2S100 FPGA.&#160;
	The FPGA is combined with a 16 MByte synchronous DRAM and 256 KByte Flash
	to give you the resources for building a complete, soft-core RISC
	microcontroller system!&#160; Or anything else you might think of...</p>
	<p>The bitstream for the XSA-100 can be stored in the on-board
	256 KByte Flash so the FPGA loads its configuration as soon as power is
	applied.&#160; Or you can download directly to the board through the parallel port
	with the XSTOOLs utilities we provide.&#160; The interface CPLD on the
	XSA-100 also supports downloading with XILINX iMPACT and circuit test/debug
	with ChipScope software using our simple downloading cable.&#160; No more expensive
	XILINX cables!
        </p><p>In addition to the large FPGA, SDRAM and Flash chips, you also get
        a VGA port that produces vivid graphics in 64 colors.  And the prototyping header
        gives you 53 general-purpose I/O pins for building interfaces to external devices.
        And you can access a variety of interfaces by inserting the XSA-100 into one of our <a href="prod037.php">XStend 3.0 Boards</a>.
	</p><p>And the XSA-100 helps you maintain your investment.&#160; Use your
	existing <a href="prod033.php">XStend 2.1 Boards</a> and
	keep your power supplies - the XSA-100 has the same power connections as
	the XS40 Board.</p>
	<p>Think it will be a big switch to move from the XS40 Boards to the
	XSA-100?&#160; Well, we provide all the software utilities for programming
	the FPGA, setting the oscillator frequency, and downloading and uploading
	...
	were a simple static RAM.&#160; And we will be adapting all the chapters
	of our <a href="http://www.xess.com/prods/prod046.php">Pragmatic Logic Design</a> online text
	to support the XSA-100.</p>
  
	<table align="center"><tr><td align="center"><img src="../images/XSA-100-LABELED.png" alt="XESS product picture"/></td></tr><tr><td align="center"><img src="../images/XSA-block-diag.png" alt="XESS product picture"/></td></tr></table></div>
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fxsa-100%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fxsa-100%252F"
