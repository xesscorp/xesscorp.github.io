...
<meta name="description" content="XESS XSA-3S1000 FPGA plus 32 MByte SDRAM development board.">
<title>XSA-3S1000 | XESS Corp.</title>
...
<script>var variations = [{"sku": "X00035", "image_id": 25, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-25-large"><a class="product-image-large thumbnail" rel="#image-full-25" href="../static/media/product/XSA-3S1000-LABELED.png"><img alt="XSA-3S1000 image 1" src="../static/media/product/.thumbnails/XSA-3S1000-LABELED-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-25"><img src="../static/media/product/XSA-3S1000-LABELED.png"></div></li><li id="image-26-large"style="display:none;"><a class="product-image-large thumbnail" rel="#image-full-26" href="../images/XSA-200_3S1000-block-diag.png"><img alt="XSA-3S1000 image 2" src="../static/media/product/.thumbnails/XSA-200_3S1000-block-diag-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-26"><img src="../images/XSA-200_3S1000-block-diag.png"></div></li></ul><ul id="product-images-thumb" class="thumbnails"><li><a class="thumbnail" id="image-25" href="../static/media/product/XSA-3S1000-LABELED.png"><img alt="XSA-3S1000 image 1" src="../static/media/product/.thumbnails/XSA-3S1000-LABELED-75x75.png"></a></li><li><a class="thumbnail" id="image-26" href="../images/XSA-200_3S1000-block-diag.png"><img alt="XSA-3S1000 image 2" src="../static/media/product/.thumbnails/XSA-200_3S1000-block-diag-75x75.png"></a></li></ul>
...
<li>2 MByte Flash</li>
<li>100 MHz oscillator</li>
<li>Parallel port</li>
<li>Keyboard/mouse PS/2 port</li>
<li>512-color VGA port</li>
<li>7-segment LED</li>
<li>2 pushbuttons</li>
<li>4 DIP switches</li>
<li>84-pin prototyping interface (65 free I/O pins)</li>
<li>5V DC power jack</li>
<li>5V / 3.3V / 2.5V / 1.2V regulators</li>
...
<li>Requires Win2K or WinXP. <strong>Not supported by Win98 or WinME!</strong></li>
</ul>
...
<li><a href="../manuals/xsa-3S-manual-v1_1.pdf">XSA-3S1000 Board Manual (PDF file)</a></li>
<li><a href="../manuals/XSA-3S-pins.xls">XSA-3S1000 Board Pin List (Excel file)</a></li>
</ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="9" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593967250" /><input id="id_security_hash" name="security_hash" type="hidden" value="35ee34fb0e184e930f22e86346b654ca7e92ad90" /></li></ul>
...
<p>The XSA-3S1000 Board keeps the same form-factor as our popular <a href="prod026.php">XSA-100 Board</a> while increasing the logic density to 1,000,000 gates with a Spartan-3 XC3S1000 FPGA.&nbsp; And it does it for only $199!</p>
<p>The FPGA is combined with a 32 MByte synchronous DRAM and 2 MByte Flash to give you the resources for building a complete, soft-core RISC microcontroller system!&nbsp; Or anything else you might think of...</p>
<p>Up to four unique bitstreams can be stored in the Flash and you can set the switches to select which bitstream configures the FPGA when power is applied.&nbsp; Or you can download directly to the FPGA through the parallel port with the XSTOOLs utilities we provide.&nbsp; The interface CPLD on the XSA-3S1000 also supports downloading with XILINX iMPACT and circuit test/debug with ChipScope using our simple downloading cable.&nbsp; No more expensive XILINX cables!</p>
<p>In addition to the larger FPGA, SDRAM and Flash chips, you also get a VGA port that produces vivid graphics in 512 colors. And the prototyping header gives you 65 general-purpose I/O pins that are completely free for building interfaces to external devices. And you can access a variety of interfaces by inserting the XSA-3S1000 into one of our <a href="prod042.php">XStend 4.0 Boards</a>.</p>
<p>Think it will be a big switch to move to the XSA-3S1000?&nbsp; Well, we provide all the software utilities for programming the FPGA, and downloading and uploading the RAM and Flash.&nbsp; And we make all the source code available for you to play with!&nbsp; How about design examples?&nbsp; We have parameterized modules for interfacing to the PS/2 keyboard port, displaying images through the VGA port, and reading/writing to the synchronous DRAM as if it were a simple static RAM.&nbsp; And we will be adapting all the chapters of our <a href="http://www.xess.com/prods/prod046.php">Pragmatic Logic Design</a> online text to support the XSA-3S1000.</p>
</div>
...
<ul id="related-products" class="thumbnails">
    ...
    <li>
        <a class="thumbnail" href="prod042.php">
            
            <img src="../static/media/product/.thumbnails/XST-4_0-90x90.png">
    ...
    <li>
        <a class="thumbnail" href="../shop/product/xsusb/index.html">
            
            <img src="../static/media/product/.thumbnails/xsusb-90x90.jpg">
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fxsa-3s1000%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fxsa-3s1000%252F"
