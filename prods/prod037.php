...
<script>var variations = [{"sku": "X00037", "image_id": 79, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-79-large"><a class="product-image-large thumbnail" rel="#image-full-79" href="../images/XST-3_0.png"><img alt="XST-3.0 image 0" src="../static/media/product/.thumbnails/XST-3_0-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-79"><img src="../images/XST-3_0.png"></div></li></ul>
...
<ul class="documentation"><li><a href="../manuals/xst-manual-v3_0.pdf">XST-3.0 Board Manual (PDF file)</a>
	</li><li><a href="../manuals/XSA+XST3-pins.xls">XST-3.0 Board Pin List (Excel file)</a>
	</li></ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="54" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593966699" /><input id="id_security_hash" name="security_hash" type="hidden" value="d299c5291992716b9a3cbc2e867b8724f90e6f11" /></li></ul>
...
<div class="StdPageBody">
    ...
    </ul><table align="center"><tr><td align="center"><img src="../images/XST-3_0.png" alt="XESS product picture"/></td></tr></table></div>
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fxst-30%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fxst-30%252F"
