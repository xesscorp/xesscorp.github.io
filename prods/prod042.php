...
<script>var variations = [{"sku": "X00042", "image_id": 27, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-27-large"><a class="product-image-large thumbnail" rel="#image-full-27" href="../static/media/product/XST-4_0.png"><img alt="XST-4.0 image 1" src="../static/media/product/.thumbnails/XST-4_0-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-27"><img src="../static/media/product/XST-4_0.png"></div></li></ul>
...
<ul class="features"><li>10/100 Ethernet MAC+PHY</li>
      <li>20-bit stereo codec</li>
      <li>stereo in/out ports</li>
      <li>8-bit video decoder</li>
      <li>dual RCA video input ports</li>
      <li>USB 1.1/2.0 peripheral-mode interface</li>
      ...
      <li>LED digits (2)</li>
      <li>LED bargraph</li>
      <li>dual daughterboard connectors</li>
      <li>prototyping area</li>
      <li><strong>Not compatible with XS95, XS40 or CSoC Boards!!</strong></li>
	</ul>
...
<ul class="documentation"><li><a href="../manuals/xst-manual-v4_0.pdf">XST-4.0 Board Manual (PDF file)</a>
	</li><li><a href="../manuals/XSA+XST4-pins.xls">XST-4.0 Board Pin List (Excel file)</a>
	</li></ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="10" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593966430" /><input id="id_security_hash" name="security_hash" type="hidden" value="7bef60dfcd0392c75c4f079bea75636693a1d412" /></li></ul>
...
<div class="StdPageBody">The XStend Board provides additional support circuitry that the XSA Boards can access through their prototyping interfaces.  This circuitry extends the range of applications of the XSA Boards into these new areas:
<ul>
<li>The pushbuttons, DIP switches, LEDs, and prototyping area are useful for basic lab experiments.</li>
<li>The stereo codec and dual-channel analog I/O circuitry are useful for processing audio signals in combination with DSP components synthesized with XILINX's CORE generation software.</li>
<li>The video decoder allows digitization of NTSC/PAL/SECAM video for image processing applications.</li>
<li>The 10/100 Ethernet interface lets the XSA Board access TCP/IP and other types of networks.</li>
<li>The USB 1.1/2.0 interface lets the XSA Board appear as a low-speed or full-speed USB peripheral to a PC.</li>
<li>The RS-232 interface is useful when the XSA Board needs to send information over a low-speed serial communication link.</li>
<li>The IDE interface provides the XSA Board with access to a hard disk for data storage and retrieval.</li>
<li>External modules with new functions can be added through the daughterboard connectors.</li>
<li>Custom circuitry can be built in the prototyping area.</li>
</ul>
</div>
...
<ul id="related-products" class="thumbnails">
    ...
    <li>
        <a class="thumbnail" href="prod035.php">
            
            <img src="../static/media/product/.thumbnails/XSA-3S1000-LABELED-90x90.png">
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fxst-40%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fxst-40%252F"
