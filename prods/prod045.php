...
<meta name="description" content="This CDROM contains the testing and configuration software utilities for the XESS FPGA/CPLD boards.">
<title>XSTOOLS-CDROM | XESS Corp.</title>
...
<script>var variations = [{"sku": "X00045", "image_id": 81, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-81-large"><a class="product-image-large thumbnail" rel="#image-full-81" href="../static/media/product/xstools-cdrom.png"><img alt="XSTOOLs CDROM" src="../static/media/product/.thumbnails/xstools-cdrom-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-81"><img src="../static/media/product/xstools-cdrom.png"></div></li></ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="13" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593966404" /><input id="id_security_hash" name="security_hash" type="hidden" value="3cd7a406f82819b213742566b6169e2cce817f7b" /></li></ul>
...
<p><strong>Everything on the XSTOOLs CD is freely available on this website. </strong> If you still want a physical CD, you can purchase one for the price shown above.</p>
<p>The XSTOOLS CDROM contains the following items:</p>
<dl>
<dt>Software Utilities</dt>
<dd>
<ul>
<li>GXSTEST / XSTEST: GUI / command-line utilities to run diagnostics on all XESS board models.</li>
<li>GXSLOAD / XSLOAD: GUI / command-line utilities to load configuration bitstreams into the FPGA and/or CPLD, upload/download the RAM and upload/download the Flash on all XESS board models.</li>
<li>GXSPORT / XSPORT: GUI / command-line utilities to send up to eight logic signals through the PC parallel port to the XESS Board. (Not supported by the XuLA Boards.)</li>
<li>GXSSETCLK / XSSETCLK: GUI / command-line utilities to set the frequency of the programmable oscillator on all XESS board models. (Not supported by XESS boards with fixed oscillators like the XSA and XuLA Boards.)</li>
<li>GXSFLAGS: GUI utility for setting/clearing flags that configure the operation of the XuLA Boards.</li>
</ul>
</dd>
<dt>Documentation</dt>
<dd>
<ul>
<li>Complete manuals for all XESS products.</li>
<li>Xilinx ISE WebPACK projects containing XESS design examples.</li>
<li>Application notes and tutorials.</li>
</ul>
</dd>
</dl>
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fxstools-cdrom%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fxstools-cdrom%252F"
