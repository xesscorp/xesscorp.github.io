...
<meta name="description" content="XESS XuLA-200 FPGA plus 8 MByte SDRAM prototyping board.">
<title>XuLA-200 | XESS Corp.</title>
...
<script>var variations = [{"sku": "X00048", "image_id": 83, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-83-large"><a class="product-image-large thumbnail" rel="#image-full-83" href="../static/media/product/XuLA_1.png"><img alt="XuLA-200 image 3" src="../static/media/product/.thumbnails/XuLA_1-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-83"><img src="../static/media/product/XuLA_1.png"></div></li><li id="image-6-large"style="display:none;"><a class="product-image-large thumbnail" rel="#image-full-6" href="../images/XuLA_quarter.png"><img alt="XuLA-200 image 1" src="../static/media/product/.thumbnails/XuLA_quarter-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-6"><img src="../images/XuLA_quarter.png"></div></li><li id="image-7-large"style="display:none;"><a class="product-image-large thumbnail" rel="#image-full-7" href="../images/XuLA_block_diagram.png"><img alt="XuLA-200 image 2" src="../static/media/product/.thumbnails/XuLA_block_diagram-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-7"><img src="../images/XuLA_block_diagram.png"></div></li></ul><ul id="product-images-thumb" class="thumbnails"><li><a class="thumbnail" id="image-83" href="../static/media/product/XuLA_1.png"><img alt="XuLA-200 image 3" src="../static/media/product/.thumbnails/XuLA_1-75x75.png"></a></li><li><a class="thumbnail" id="image-6" href="../images/XuLA_quarter.png"><img alt="XuLA-200 image 1" src="../static/media/product/.thumbnails/XuLA_quarter-75x75.png"></a></li><li><a class="thumbnail" id="image-7" href="../images/XuLA_block_diagram.png"><img alt="XuLA-200 image 2" src="../static/media/product/.thumbnails/XuLA_block_diagram-75x75.png"></a></li></ul>
...
<ul class="features">
<li><strong>Lower price!</strong></li>
...
<li><a href="../manuals/XuLA-manual.pdf">XuLA-200 Board Manual</a></li>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="6" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593966425" /><input id="id_security_hash" name="security_hash" type="hidden" value="f26a70368a3c580c7769f9291a6e3560642ea3c1" /></li></ul>
...
<h1>"I need a circuit that does X...</h1>
<p>... or maybe I just need to add a feature to an existing design."</p>
<h1>"Maybe a small micro will do it...</h1>
<p>... but there's a signal that's a bit too fast and my micro is a bit too slow."</p>
<h1>"Maybe I'll try an FPGA...</h1>
<p>... but now I have to add an FPGA and a Flash to hold its configuration bitstream. And I have to figure out how to do in-circuit loading of the Flash. And don't forget the multiple voltage supplies the FPGA needs."</p>
<h1>"I'll just use an existing FPGA development board...</h1>
<p>... if I can find one small enough. And if I can afford to pay for a bunch of features I don't need. And if I can find a mate for the board's funky high-density I/O connector."</p>
<h1>That's why we built the XuLA Boards (pronounced "ZOO-LAH").</h1>
<p>They're built to provide just the things you need so you can spend your time adding the features you want. The XuLA Board crams a 200,000-gate FPGA, 8 MByte SDRAM, 2 Mbit Flash, two voltage regulators and a supervisory microcontroller into a 2" x 1" footprint (51 mm x 25 mm for you metric guys). Just plug the XuLA Board into your circuit and connect a USB cable to download and test your design. Once you have your design just the way you want it, you can program it into the Flash and the XuLA Board will load it whenever power is applied. It's really that simple.</p>
<h1>It's not perfect &mdash; we left that up to you.</h1>
<p>We've learned over the past twenty years that we can't anticipate everything you want. And we don't have the resources to design and build every board variation you can think of. <em>So we gave up and made the entire XuLA design open-source.</em> <a href="../open_source.php">All of it: firmware, bitstreams, schematic, PCB layout, documentation &mdash; everything!</a> If you don't like what we built, you can re-design it and build it your way. And you can sell it to others free-and-clear of any royalties. (But you have to open-source your design just like we do.) And as others do this, you may find someone has built a version of XuLA that <em>is</em> perfect for you.</p>
<h1>Now what?</h1>
<p>Now it's up to you. You can read the FAQ that follows to get more information, and peruse the <a href="../manuals/XuLA-manual.pdf">XuLA Board manual</a> for all the details. <a href="mailto:info@xess.com?subject=XuLA Question">Send us an email</a> if you can't find an answer to your question. Then decide if you want to keep forcing your designs into an inflexible system, or if you'd rather take the responsibility to freely build a solution that fits.</p>
<p><em>It's really that simple.</em></p>
<h1 class="toggle_title">FAQ</h1>
<div class="toggle_body">
<h2 class="toggle_title">Why is the XuLA-200 no longer sold?</h2>
<p class="toggle_body"><a href="../shop/product/xula2-lx9">A comparison of the XuLA-200 and XuLA2-LX9</a> shows the XuLA2-LX9 provides much more logic and RAM for nearly the same price, so we decided to discontinue the XuLA-200 rather than devote resources to it.</p>
<h2 class="toggle_title">I ordered a XuLA and all I got was a board. No software? No cable? <em>No fancy box!?</em></h2>
<p class="toggle_body">When you order a XuLA, all you get is the board. That's it. Take a look at the related products on the left if you need a software CD, cables, etc. As for the fancy box, well, sorry about that. Think of it as "saving the environment".</p>
<h2 class="toggle_title">What kind of instructions are there for using the XuLA?</h2>
<p class="toggle_body">We are currently writing and releasing an <a href="../appnotes/FpgasNowWhatBook.pdf">open-source book</a> that shows how to use the XuLA with the Xilinx ISE WebPACK software to do FPGA designs. There are also some <a href="https://github.com/xesscorp/XuLA/tree/master/FPGA">pre-built projects for XuLA</a>. <!--
	...
	--></p>
<h2 class="toggle_title">How does the XuLA get power?</h2>
<p class="toggle_body">The XuLA can get power through the USB port or directly through one or more of the voltage supply pins on its prototyping header. Or you can use a combination of both methods.</p>
<h2 class="toggle_title">Only a 12 MHz oscillator? That's kind of slow!</h2>
<p class="toggle_body">That's just the frequency of the clock going into the FPGA. The Spartan3A FPGAs contain Digital Clock Managers (DCMs) that can multiply the frequency of the input clock up to 384 MHz (32x). The DCMs also have dividers so you can generate a wide range of clock frequencies to use in your designs. And you can cascade DCMs together to generate even more frequencies.</p>
<h2 class="toggle_title">How long does it take to download a bitstream?</h2>
<p class="toggle_body">Fractions of a second if you are downloading a bitstream directly to the FPGA. Downloading into the Flash takes a bit longer, but it's still less than a minute.</p>
...
<p class="toggle_body">Not unless you put the XuLA Board into a mode where the SDRAM is disabled. Then the FPGA can access the Flash without interference, but you lose access to the SDRAM.</p>
...
<p class="toggle_body">The XSTOOLs software provides both command-line and GUI-based programs for transfering data between the PC and the XuLA Board.</p>
<h2 class="toggle_title">How much power does the XuLA Board need?</h2>
<div class="toggle_body">
...
<p class="toggle_body">Yes, but you will need a Xilinx or third-party JTAG cable to connect to the XuLA's auxiliary JTAG port.</p>
<h2 class="toggle_title">If I use a XuLA Board in my product, do I have to open-source my entire product?</h2>
<p class="toggle_body">Not if you just insert a pre-built XuLA Board into a socket in your product. In that case, your product is similar to a software application that uses the XuLA Board like a library of precompiled functions. The application doesn't have to be open-sourced and neither does your product.</p>
</div>
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fxula-200%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fxula-200%252F"
