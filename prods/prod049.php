...
<meta name="description" content="XESS XuLA-ACC-1 accessory pack.">
<title>XuLA-ACC-1 | XESS Corp.</title>
...
<script>var variations = [{"sku": "X00049", "image_id": 24, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-24-large"><a class="product-image-large thumbnail" rel="#image-full-24" href="../static/media/product/XuLA_ACC.png"><img alt="XuLA-ACC-1 image 1" src="../static/media/product/.thumbnails/XuLA_ACC-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-24"><img src="../static/media/product/XuLA_ACC.png"></div></li></ul>
...
<ul class="features"><li>One USB 2.0 cable</li>
	<li>Two 20-pin headers with 0.025" square pins</li>
	<li>Two 20-pin headers with 0.020" round pins</li>
	<li>Three 2-pin jumpers</li>
	<li>Three shunts</li>
	<li>One 2x2 header</li>
	</ul>
...
<ul class="documentation"><li><a href="../manuals/XuLA-manual.pdf">XuLA Board Manual (PDF file)</a>
	</li></ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="8" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593966760" /><input id="id_security_hash" name="security_hash" type="hidden" value="ddf6a018f906fd6139b0b8c85a321c5264081dc2" /></li></ul>
...
<div class="StdPageBody">The XuLA-ACC-1 Accessory Pack provides a few items that you may want for your <a href="../shop/product/xula2-lx9">XuLA2-LX9</a> or <a href="prod055.php">XuLA2-LX25</a> Board:
<ul>
<li>One USB 2.0 A-to-mini-B cable.</li>
<li>Two 20-pin headers with square 0.025" pins for use in the prototyping header.</li>
<li>Two 20-pin headers with round 0.020" pins also for use in the prototyping header. (The thinner pins of these headers make it easier to insert and remove your XuLA2 board from a standard solderless breadboard.)</li>
<li>Three two-pin headers for use in the power jumpers.</li>
<li>Three shunts for use with the power jumpers.</li>
<li>One 2x2 header for use in the auxiliary JTAG header.</li>
</ul>
</div>
...
<ul id="related-products" class="thumbnails">
    ...
    <li>
        <a class="thumbnail" href="../shop/product/xula2-lx9">
            
            <img src="../static/media/product/.thumbnails/XuLA2_1-90x90.png">
    ...
    <li>
        <a class="thumbnail" href="prod048.php">
            
            <img src="../static/media/product/.thumbnails/XuLA_1-90x90.png">
    ...
    <li>
        <a class="thumbnail" href="prod055.php">
            
            <img src="../static/media/product/.thumbnails/XuLA2-90x90.png">
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fxula-acc-1%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fxula-acc-1%252F"
