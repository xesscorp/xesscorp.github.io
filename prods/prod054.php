...
<meta name="description" content="XESS StickIt! VGA module.">
<title>StickIt!-VGA | XESS Corp.</title>
...
<script>var variations = [{"sku": "X00054", "image_id": 5, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-5-large"><a class="product-image-large thumbnail" rel="#image-full-5" href="../static/media/product/StickIt_Vga.png"><img alt="StickIt!-VGA image 1" src="../static/media/product/.thumbnails/StickIt_Vga-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-5"><img src="../static/media/product/StickIt_Vga.png"></div></li></ul>
...
<ul class="features"><li>VGA output</li>
	  <li>16,384 colors</li>
	  <li>Needs only 8 I/O pins!<br/>(64 color mode)</li>
	  <li>PMOD compatible</li>
	  <li>Wing compatible</li>
      <li><a href="https://github.com/xesscorp/StickIt">Open-source design</a></li>
	</ul>
...
<ul class="documentation"><li><a href="../manuals/StickIt-Vga-manual-v2_1.pdf">StickIt! VGA module manual (PDF file)</a>
	</li></ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="5" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593966848" /><input id="id_security_hash" name="security_hash" type="hidden" value="ef6ba7dc105a75ad9a69739d1eb4d16097bc7117" /></li></ul>
...
<p>This module lets you interface to a VGA monitor. Just connect it to a PMOD or Wing socket on the <a href="prod050.php">StickIt! board</a> and your <a href="prod048.php">XuLA</a> can display images with up to 16,384 colors!</p>
<p>As with the StickIt! board, we made the entire StickIt! VGA module design open-source. <a href="https://github.com/xesscorp/StickIt">All of it: bitstreams, schematic, PCB layout, documentation — everything!</a></p>
<h1 class="toggle_title">FAQ</h1>
<div class="toggle_body">
<h2 class="toggle_title">I ordered a StickIt! VGA module and all I got was a board. No software? No manual? <em>No fancy box!?</em></h2>
<p class="toggle_body">When you order a StickIt! VGA module, all you get is the board. That's it. The StickIt! VGA module doesn't need any software itself. And the <a href="../manuals/StickIt-Vga-manual-v2_0.pdf">manual is online</a>. As for the fancy box, well, sorry about that. Think of it as "saving the environment".</p>
<h2 class="toggle_title">What kind of instructions are there for using the StickIt! VGA module ?</h2>
<p class="toggle_body">The <a href="../manuals/StickIt-Vga-manual-v2_0.pdf">StickIt! VGA module manual</a> will tell you how to install your board, and it shows how the buttons are connected to the I/O pins. And there is a <a href="https://github.com/xesscorp/StickIt">design example</a> online that shows how to use it.</p>
</div>
</div>
...
<ul id="related-products" class="thumbnails">
    ...
    <li>
        <a class="thumbnail" href="../shop/product/stickit-grove/index.html">
            
            <img src="../static/media/product/.thumbnails/product_cover_1-90x90.jpg">
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fstickit-vga%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../account/signup/index.html?next=%252Fshop%252Fproduct%252Fstickit-vga%252F"
