...
<meta name="description" content="XESS XSA-200 FPGA plus 32 MByte SDRAM development board.">
<title>XSA-200 | XESS Corp.</title>
...
<script>var variations = [{"sku": "X00034", "image_id": 77, "option2": null, "option1": null}];</script>
...
<div class="span9 middle">
    ...
    <div class="container">
        ...
        <ul id="product-images-large" class="thumbnails"><li id="image-77-large"><a class="product-image-large thumbnail" rel="#image-full-77" href="../../../images/XSA-200-LABELED.png"><img alt="XSA-200 image 0" src="../../../static/media/product/.thumbnails/XSA-200-LABELED-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-77"><img src="../../../images/XSA-200-LABELED.png"></div></li><li id="image-78-large"style="display:none;"><a class="product-image-large thumbnail" rel="#image-full-78" href="../../../images/XSA-200_3S1000-block-diag.png"><img alt="XSA-200 image 1" src="../../../static/media/product/.thumbnails/XSA-200_3S1000-block-diag-0x300.png"></a><div class="product-image-full" style="display:none;" id="image-full-78"><img src="../../../images/XSA-200_3S1000-block-diag.png"></div></li></ul><ul id="product-images-thumb" class="thumbnails"><li><a class="thumbnail" id="image-77" href="../../../images/XSA-200-LABELED.png"><img alt="XSA-200 image 0" src="../../../static/media/product/.thumbnails/XSA-200-LABELED-75x75.png"></a></li><li><a class="thumbnail" id="image-78" href="../../../images/XSA-200_3S1000-block-diag.png"><img alt="XSA-200 image 1" src="../../../static/media/product/.thumbnails/XSA-200_3S1000-block-diag-75x75.png"></a></li></ul>
...
<ul class="features"><li>XC2S200 FPGA</li>
      <li>XC9572XL CPLD</li>
...
<ul class="documentation"><li><a href="../../../manuals/xsa-manual-v1_3.pdf">XSA-200 Board Manual (PDF file)</a>
	</li><li><a href="../../../manuals/XSA-200-pins.xls">XSA-200 Board Pin List (Excel file)</a>
	</li></ul>
...
</ul><input id="id_content_type" name="content_type" type="hidden" value="shop.product" /><input id="id_object_pk" name="object_pk" type="hidden" value="53" /><input id="id_timestamp" name="timestamp" type="hidden" value="1593966698" /><input id="id_security_hash" name="security_hash" type="hidden" value="ab666562695b9c221cbb9b5c260ffd15fdbc06f1" /></li></ul>
...
<div class="StdPageBody">
	...
	<p>The XSA-200 Board keeps the same form-factor as our
	popular <a href="../../../prods/prod026.php">XSA-100 Board</a> while increasing the logic
	density to 200,000 gates with a Spartan-II XC2S200 FPGA.</p>
	<p>The FPGA is combined with a 32 MByte synchronous DRAM and 2 MByte Flash
	...
	<p>Up to four unique bitstreams can be stored in the Flash and you can set the switches to select
	...
	XSA-200 also supports downloading with XILINX iMPACT
	and circuit test/debug with ChipScope using our simple downloading cable.&#160;
        No more expensive XILINX cables!
        </p><p>In addition to the larger FPGA, SDRAM and Flash chips, you also get
        a VGA port that produces vivid graphics in 512 colors.  And the prototyping header
        gives you 72 general-purpose I/O pins that are completely free for
        building interfaces to external devices.
        And you can access a variety of interfaces by inserting the XSA-200 into one of our <a href="../../../prods/prod042.php">XStend 4.0 Boards</a>.
	</p><p>And the XSA-200 helps you maintain your investment.&#160; Use your
	existing <a href="../../../prods/prod033.php">XStend 2.1 Boards</a> and
	keep your power supplies - the XSA-200 has the same power connections as
	the XSA-100 Board.</p>
	<p>Think it will be a big switch to move to the	XSA-200?&#160;
	...
	to support the XSA-200.</p>
  
	<table align="center"><tr><td align="center"><img src="../../../images/XSA-200-LABELED.png" alt="XESS product picture"/></td></tr><tr><td align="center"><img src="../../../images/XSA-200_3S1000-block-diag.png" alt="XESS product picture"/></td></tr></table></div>
...
<div class="panel">
    ...
    0 items
    in cart:
    $0.00</a><br><br><a href="../../../accounts/login/index.html?next=%252Fshop%252Fproduct%252Fxsa-200%252F"
        class="btn btn-small btn-account">Log in</a>
    or
    <a href="../../../account/signup/index.html?next=%252Fshop%252Fproduct%252Fxsa-200%252F"
